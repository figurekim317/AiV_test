...
class CameraType1(Node):
    """CameraType1 Node: Publishes image data upon receiving a capture request."""
    ...
    def __init__(self):
        ...
        self.get_logger().info("CameraType1 initialized and ready to capture images.")

    def capture_callback(self, msg):
        """Callback function that triggers image capture upon receiving a request."""
        if msg.data == "capture":
            self.get_logger().info("Capture request received. Capturing image...")
            self.publish_image()
    ...
    def publish_image(self):
        ...
        self.get_logger().info("Image captured and published successfully.")
